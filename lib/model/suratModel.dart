...
List<ListSuratModel> listSuratModelFromJson(String str) =>
    List<ListSuratModel>.from(
        json.decode(str).map((x) => ListSuratModel.fromJson(x)));

String listSuratModelToJson(List<ListSuratModel> data) =>
