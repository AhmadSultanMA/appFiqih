  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          Container(
        width: MediaQuery.of(context).size.width - 1 * 0.1,
        height: MediaQuery.of(context).size.width - 2 * 64,
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/images/sunset-view.jpg"),fit: BoxFit.cover),
        ),
        child: Container(
            color: Color.fromRGBO(0, 0, 0, 0.6),
              child: Padding(
                padding: EdgeInsets.fromLTRB(120, 100, 20, 20),
                child: Text("Dzikir Pagi",style: TextStyle(
                        fontFamily: 'Avenir',
                        fontSize: 25,
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                ...
                                SizedBox(height:20),
                            Text(
                                '“Tidak ada Ilah yang berhak diibadahi dengan benar selain Allah Yang Maha Esa, tidak ada sekutu bagi-Nya. Bagi-Nya kerajaan dan bagi-Nya segala puji. Dan Dia Mahakuasa atas segala sesuatu.” (Dibaca 10x atau dibaca 1x pada pagi dan sore)',
                                style: TextStyle(fontSize: 20)),
                                SizedBox(height:20),
